		...
		B_NOT_ZOOMABLE | B_NOT_MINIMIZABLE | B_AUTO_UPDATE_SIZE_LIMITS)
{
	...
	infoText << B_TRANSLATE(
		"Welcome to the Schwarzpause OS Installer!\n\n");
	infoText << B_TRANSLATE(
		"IMPORTANT INFORMATION BEFORE INSTALLING SCHWARZPAUSE OS\n\n");
	infoText << B_TRANSLATE(
		"This is beta-quality software! It means there is a risk of "
		"losing important data. Make frequent backups! You have been "
		"warned.\n\n\n");
	infoText << B_TRANSLATE(
		"1)   If you are installing Schwarzpause OS onto real hardware (not inside an "
	...
	infoText << "\n\n\n";
	infoText << B_TRANSLATE(
		"2)   The Installer will make the Schwarzpause OS partition itself bootable, "
		"but takes no steps to integrate Schwarzpause OS into an existing boot menu. "
		"If you have GRUB already installed, you can add Schwarzpause OS to it.\n"
		"For details, please consult the booting guidance shipped with "
		"Schwarzpause OS.\n"
		"Or you can set up a boot menu from Installer's \"Tools\" menu, see "
		"the user guide topic on the application \"BootManager\"."
		"\n\n\n");
	infoText << B_TRANSLATE(
		"3)   When you successfully boot into Schwarzpause OS for the first time, make "
		"sure to read our \"User Guide\" and take the \"Quick Tour\". There "
		"are links on the Desktop and in WebPositive's bookmarks.\n\n");
	infoText << B_TRANSLATE(
		"Have fun and thanks for trying out Schwarzpause OS!");
